...
switch params.adapt_type
    ...
    case 'residual'
        C_star_new_ordered = C_new_ordered;
end
...
for ii = 1:length(old_pts);
    ...
    Z_I_star_refined{old_pts(ii)}.dt_z_tplusdt  = Z_I_star{old_pts_in_I_star(ii)}.dt_z_tplusdt;
    Z_I_star_refined{old_pts(ii)}.t_z           = Z_I_star{old_pts_in_I_star(ii)}.t_z;
    Z_I_star_refined{old_pts(ii)}.tplusdt       = Z_I_star{old_pts_in_I_star(ii)}.tplusdt;
    Z_I_star_refined{old_pts(ii)}.dt_z          = Z_I_star{old_pts_in_I_star(ii)}.dt_z;
    Z_I_star_refined{old_pts(ii)}.w             = Z_I_star{old_pts_in_I_star(ii)}.w;
    Z_I_star_refined{old_pts(ii)}.n_steps       = Z_I_star{old_pts_in_I_star(ii)}.n_steps;
    Z_I_star_refined{old_pts(ii)}.ge_estimate   = Z_I_star{old_pts_in_I_star(ii)}.ge_estimate;
end
